...
/**
 * FireMissileAction implements dropping a marker from the avatar.
 * This InputAction works with the keyboard.
 */
public class DropMarkerActionK extends AbstractInputAction {
    ...
    /** <code> FireMarkerActionK() </code> is invoked to execute this input action.
     ...
     */
    public DropMarkerActionK(MyGame game, float factor) {
        this.game = game;
